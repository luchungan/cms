            ...
            <div class="drag-box">
                <div class="drag-box-item">
                    ...
                    <draggable v-model="todo" @remove="removeHandle" :options="dragOptions">
                        <transition-group tag="div" id="todo" class="item-ul">
                            <div class="drag-list"  v-for="item in todo" :key="item.id">
                                {{item.content}}
                            </div>
                        </transition-group>
                ...
                <div class="drag-box-item">
                    ...
                    <draggable v-model="doing" @remove="removeHandle" :options="dragOptions">
                        ...
                        <div class="drag-list" v-for="item in doing" :key="item.id">
                            {{item.content}}
                        </div>
                        </transition-group>
                    </draggable>
                ...
                <div class="drag-box-item">
                    ...
                    <draggable v-model="done" @remove="removeHandle" :options="dragOptions">
                        ...
                        <div class="drag-list" v-for="item in done" :key="item.id">
                            {{item.content}}
                        </div>
                        </transition-group>
                    </draggable>
